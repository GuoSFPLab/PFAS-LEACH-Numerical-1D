...
## Linux Binary Example Package

This package contains the Linux x86_64 binary version of `ESTCP-PFAS-LEACH-Numerical-1D` together with three example cases.
...
- Linux uses `Run.sh`; Windows uses `Run.bat`.
