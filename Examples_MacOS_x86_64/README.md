...
## macOS x86_64 Binary Example Package

This package contains the macOS Intel binary version of `ESTCP-PFAS-LEACH-Numerical-1D` together with three example cases.
